...
-->
    ...
    <style>
        ...
        .btn{position: relative;left: 230px;}
    </style>
    </head>
    ...
    <div  class="container" style="position:relative;top:100px">
        <form action="{{ url('/order/store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="foodname" id="inputfoodname" class="form-control" value="{{$data->title}}" hidden>
            </div>
            <div class="form-group">
                <label for="inputprice">Price</label>
                <input type="number" name="price" id="inputprice" class="form-control" value="{{$data->price}}" hidden>
            </div>
            <div class="form-group">
                <label for="inputquantity">Quantity</label>
                <input type="number" name="quantity" id="inputquantity" class="form-control" value="1" hidden>
            </div>
            <div class="form-group">
